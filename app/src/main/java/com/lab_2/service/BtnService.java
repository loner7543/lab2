...
/**
 * Created by Александр on 22.12.2016.
 */
// Получение данных по кнопке
public class BtnService extends IntentService {
    public static final String LOG_TAG = "MY_SERVICE";
    public static final String ACTION_MYINTENTSERVICE = "com.meetingroom1.RESPONSE";
    public static final String NETWORK = "NETWORK";
    public static final String MEETINGS = "MEETINGS";
    private List<Meeting> meetings;
    private BtnService.MeetingListListenerTime meetingListener;
    private Intent NotificationIntent;

    public BtnService(String name) {
        super(name);
    }
    ...
    public void onShowNotification(){
        ...
        builder.setContentIntent(pendingIntent)
                ...
                .setContentText("Сервис получения данных по кнопке"); // Текст уведомления
